 ...
 * element interface generated in the clientBase64 package.
 * <p>
...
public class ObjectFactory {
	...
	private final static QName _GetImagesResponse_QNAME = new QName(
	        "http://images/", "getImagesResponse");
	private final static QName _GetImageResponse_QNAME = new QName(
	        "http://images/", "getImageResponse");
	private final static QName _GetImage_QNAME = new QName("http://images/",
	        "getImage");
	private final static QName _GetImages_QNAME = new QName("http://images/",
	        "getImages");

	/**
	 * Create a new ObjectFactory that can be used to create new instances of
	 * schema derived classes for package: clientBase64
	 * 
	 */
