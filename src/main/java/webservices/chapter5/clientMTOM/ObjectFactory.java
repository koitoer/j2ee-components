...
public class ObjectFactory {
    ...
    private final static QName _GetImages_QNAME = new QName("http://server.base64attach.chapter5.webservices.koitoer.com/", "getImages");
    private final static QName _GetImage_QNAME = new QName("http://server.base64attach.chapter5.webservices.koitoer.com/", "getImage");
    private final static QName _GetImageResponse_QNAME = new QName("http://server.base64attach.chapter5.webservices.koitoer.com/", "getImageResponse");
    private final static QName _GetImagesResponse_QNAME = new QName("http://server.base64attach.chapter5.webservices.koitoer.com/", "getImagesResponse");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.base64attach.chapter5.webservices.koitoer.com/", name = "getImages")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.base64attach.chapter5.webservices.koitoer.com/", name = "getImage")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.base64attach.chapter5.webservices.koitoer.com/", name = "getImageResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.base64attach.chapter5.webservices.koitoer.com/", name = "getImagesResponse")
