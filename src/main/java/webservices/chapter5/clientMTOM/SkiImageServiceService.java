 ...
 * 
 */
@WebServiceClient(name = "SkiImageServiceService", targetNamespace = "http://server.base64attach.chapter5.webservices.koitoer.com/", wsdlLocation = "http://localhost:9876/skir?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SKIIMAGESERVICESERVICE_QNAME = new QName("http://server.base64attach.chapter5.webservices.koitoer.com/", "SkiImageServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:9876/skir?wsdl");
    ...
    public SkiImageService getSkiImageServicePort() {
        return super.getPort(new QName("http://server.base64attach.chapter5.webservices.koitoer.com/", "SkiImageServicePort"), SkiImageService.class);
    }
    ...
    public SkiImageService getSkiImageServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://server.base64attach.chapter5.webservices.koitoer.com/", "SkiImageServicePort"), SkiImageService.class, features);
    }
