...
@WebServiceClient(
        name = "EchoService",
        targetNamespace = "http://transport.chapter5.webservices.koitoer.com/",
        ...
        extends Service
{
	...
	private final static QName ECHOSERVICE_QNAME = new QName(
	        "http://transport.chapter5.webservices.koitoer.com/", "EchoService");
	...
	public Echo getEchoPort(){
		return super.getPort(new QName(
		        "http://transport.chapter5.webservices.koitoer.com/",
		        "EchoPort"), Echo.class);
	}
