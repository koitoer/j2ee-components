 ...
 */
@WebServiceClient(
        name = "PredictionsSOAPService",
        targetNamespace = "http://soaphandlers.chapter5.webservices.koitoer.com/",
        wsdlLocation = "http://localhost:8080/web-services/soap-webservice/predictionSOAP?wsdl")
        ...
        extends Service
{
	...
	private final static QName PREDICTIONSSOAPSERVICE_QNAME = new QName(
	        "http://soaphandlers.chapter5.webservices.koitoer.com/",
	...
	static {
		...
		try {
			url = new URL(
			        "http://localhost:8080/web-services/soap-webservice/predictionSOAP?wsdl");
