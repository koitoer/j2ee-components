 ...
 * generated in the com.koitoer.webservices.chapter4.client.wsimport package. 
...
public class ObjectFactory {
    ...
    private final static QName _Next1Response_QNAME = new QName("http://soap.chapter4.webservices.koitoer.com/", "next1Response");
    private final static QName _NextN_QNAME = new QName("http://soap.chapter4.webservices.koitoer.com/", "nextN");
    private final static QName _NextNResponse_QNAME = new QName("http://soap.chapter4.webservices.koitoer.com/", "nextNResponse");
    private final static QName _Next1_QNAME = new QName("http://soap.chapter4.webservices.koitoer.com/", "next1");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.koitoer.webservices.chapter4.client.wsimport
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://soap.chapter4.webservices.koitoer.com/", name = "next1Response")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://soap.chapter4.webservices.koitoer.com/", name = "nextN")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://soap.chapter4.webservices.koitoer.com/", name = "nextNResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://soap.chapter4.webservices.koitoer.com/", name = "next1")
