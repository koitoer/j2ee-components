 ...
 * 
 */
@WebServiceClient(name = "TempConvertService", targetNamespace = "http://tempConvert.service.server.soap.ws.jax.koitoer.com/", wsdlLocation = "file:/C:/Users/Koitoer/git/Web-Services/jax-ws/src/main/resources/wsdl/tempConverterWS.wsdl")
    ...
    extends Service
{
    ...
    private final static QName TEMPCONVERTSERVICE_QNAME = new QName("http://tempConvert.service.server.soap.ws.jax.koitoer.com/", "TempConvertService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("file:/C:/Users/Koitoer/git/Web-Services/jax-ws/src/main/resources/wsdl/tempConverterWS.wsdl");
    ...
    public TempConvert getTempConvertPort() {
        return super.getPort(new QName("http://tempConvert.service.server.soap.ws.jax.koitoer.com/", "TempConvertPort"), TempConvert.class);
    }
    ...
    public TempConvert getTempConvertPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://tempConvert.service.server.soap.ws.jax.koitoer.com/", "TempConvertPort"), TempConvert.class, features);
    }
